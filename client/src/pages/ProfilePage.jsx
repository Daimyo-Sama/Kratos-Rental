                    ...
                    {user && user.role !== 'owner' && !allTasksCompleted && (
                        <div className="mt-4 flex flex-col items-center">
                            {!isPayPalTaskCompleted && !becomeOwnerClicked && (
                                <button onClick={handleBecomeOwner} className="primary mt-4 hover:bg-blue-700">Become an Owner</button>
                            )}
                                ...
                                <>
                                    ...
                                    <form onSubmit={handleUpdatePayPalEmail} className="mt-4">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <button type="submit" className="primary mt-2 hover:bg-blue-700">Submit</button>
                                    </form>
                                </>
                            )}
                            {thankYouMessage && (
